...
public class Maze {
     ...
     * Method was refactored by the Duke Professors
	 * 
    ...
    /**
     * Method reconstructs the path from the start node to the goal node AFTER the DFS is complete
     *
     * @param start
     * @param goal
     * @param parentMap
	...
	/**
	 * Method performs a DFS search from start node to goal node in the given parent map
	 *
	 * @param start
	 * @param goal
	 * @param parentMap
