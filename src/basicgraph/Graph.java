...
public abstract class Graph {
	...
	public List<Integer> degreeSequence() {
        ...
        for(int a = 0; a < numVertices; a++){
            int count = getInNeighbors(a).size() + getNeighbors(a).size();
            output.add(count);
	...
	public static void main (String[] args) {
		...
		System.out.println("Observe most degrees are small (1-30), eight are over 100.");//only got 7
		System.out.println("****");

        System.out.println("Flight data:");
        GraphAdjList ucsd = new GraphAdjList();
        GraphLoader.loadRoadMap("data/maps/ucsd.map", ucsd);
        ...
        System.out.println(ucsd.getDistance2(0));
	}
}
